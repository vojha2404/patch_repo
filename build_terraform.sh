...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Terraform/1.10.4/build_terraform.sh
...
GO_VERSION="1.23.3"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Terraform/1.10.4/patch"
